...
@Component({
  selector: 'app-diet-meals-details',
  templateUrl: './diet-meals-details.component.html',
  styleUrls: ['./diet-meals-details.component.scss'],
  providers: [MessageService]

})
export class DietMealsDetailsComponent {
  ...
  ngOnInit() {
    ...
    this.diet_meals.forEach((meal: any) => {
      if (meal.id == id) {
        this.hot_meal = meal;
      }
    });
