...
@Component({
  selector: 'app-desserts-details',
  templateUrl: './desserts-details.component.html',
  styleUrls: ['./desserts-details.component.scss'],
  providers: [MessageService]
})
export class DessertsDetailsComponent {
  ...
  ngOnInit() {
    ...
    this.dessert_meals.forEach((meal: any) => {
      if (meal.id == id) {
        this.hot_meal = meal;
      }
    });
